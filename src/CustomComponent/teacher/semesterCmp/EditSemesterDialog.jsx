...
// Helpers (same as in your main file)
...
export default function EditSemesterDialog({
  ...
  useEffect(() => {
    if (semester) {
      form.reset({
        ...
        startDate: toLocalDateString(semester.startDate),
        endDate: toLocalDateString(semester.endDate),
      });
    }
  }, [semester]);
  ...
  const onSubmit = async (data) => {
    try {
      await axiosInstance.put(`/semester/editSemester/${semester._id}`, {
        ...data,
      ...
      <Dialog open={open}>
        ...
        <DialogContent>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-3">
            <Input placeholder="Semester Title" {...form.register("title")} />
